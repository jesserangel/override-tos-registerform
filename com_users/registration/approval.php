...
<h1>Mi override para el registro de usuario</h1>
...
<?php endforeach;?>
		<div>
			<fieldset>
				<legend><?php echo JText::_('BEEZ_20_TERMS_OF_SERVICE') ?></legend>
				<p><?php echo JText::_('BEEZ_20_AGREE') ?> <input type="checkbox" name="tos_agree" /> </p>
				<?php if($this->params->get('show_age_checkbox')) : ?>
					<p><?php echo JText::_('BEEZ_20_AGE') ?> <input type="checkbox" name="old_enough"></p>
				<?php endif; ?>
			</fieldset>
